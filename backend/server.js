//IMPORTAT O MODULO EXPRESS - framework de aplicação web para Node.js
...
//Habilita o CORS para rotas da aplicação, permitindo acesso
app.use(cors());
...
app.post('/calcularfrete', (req,res)=>{
    // destruct para o corpo da requisição
